...
import { inventoryApi, type InventoryFilters } from "@/api/inventory.api";
                  ...
                  data.data.map((product) => (
                    <TableRow key={product.id}>
                      ...
                      <TableCell className="text-right">
                        ${parseFloat(String(product.unit_price)).toFixed(2)}
                      </TableCell>
      ...
      <Dialog open={deleteId !== null} onOpenChange={() => setDeleteId(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure? This will also remove stock movement history.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
